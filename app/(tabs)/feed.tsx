        ...
        <View style={rStyles.sheet}>
          ...
          <View style={rStyles.sheetHeader}>
            ...
            <View style={rStyles.sheetUserInfo}>
              ...
              <Text style={rStyles.sheetShape}>
                {post.faceShape} face shape
              </Text>
            </View>
                ...
                >
                  ...
                  <View style={rStyles.recInfo}>
                    ...
                    >
                      ...
                      <Text style={[rStyles.rankText, { color }]}>
                        #{rec.rank}
                      </Text>
                    </View>
                    <Text style={rStyles.recName}>{rec.name}</Text>
                    <Text style={rStyles.recDesc} numberOfLines={1}>
                      {rec.description}
                    </Text>
                    <View style={rStyles.diffRow}>
                      <View
                        style={[
                          rStyles.diffDot,
                          { backgroundColor: diffColor(rec.difficulty) },
                        ]}
                      />
                      <Text
                        style={[
                          rStyles.diffText,
                          { color: diffColor(rec.difficulty) },
                        ]}
                      >
                        {rec.difficulty}
                      </Text>
      ...
      <Pressable style={fStyles.postCard} onPress={() => setModalVisible(true)}>
        <View style={fStyles.postHeader}>
          ...
          <View style={fStyles.postUserInfo}>
            ...
            <Text style={fStyles.postMeta}>
              @{item.user.username} · {timeAgo(item.post.createdAt)}
            </Text>
          </View>
        ...
        <View style={fStyles.photoRow}>
          ...
          <View style={fStyles.recsGrid}>
            {(item.post.recommendations as Recommendation[])
              .slice(0, 4)
              .map((rec) => (
    ...
    <View style={fStyles.container}>
      ...
      {isLoading ? (
        ...
        <View style={fStyles.center}>
          ...
          <Text style={fStyles.emptyText}>
            Share your haircut results from the CutMatch tab
          </Text>
        </View>
      ) : (
        <FlatList
